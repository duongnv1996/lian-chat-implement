...
public class Profile implements Parcelable {
    ...
    @Expose
    @SerializedName("user_id_request")
    ...
    private double accountWallet;    @Expose
    ...
    public String getUserIdRequestFriend() {
        return userIdRequestFriend;
    }

    public void setUserIdRequestFriend(String userIdRequestFriend) {
        this.userIdRequestFriend = userIdRequestFriend;
    }
